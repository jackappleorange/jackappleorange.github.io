...
lib.ssMetadata = [
		{name:"B2A10lady_atlas_1", frames: [[0,0,623,434],[0,436,278,280],[581,467,153,408],[625,0,180,465],[280,669,192,322],[0,718,231,138],[280,436,299,231],[474,877,312,103],[474,669,54,128]]}
];
...
(lib.CachedBmp_9 = function() {
	this.initialize(ss["B2A10lady_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.B2A10lady = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/圖層3.png?1765639704601", id:"圖層3"},
		{src:"images/B2A10lady_atlas_1.png?1765639704583", id:"B2A10lady_atlas_1"}
	],
	preloads: []
};
